<template>
  <v-carousel height="85vh">
    ...
    >
      <div v-show="item.src === '/img/paisagem3.jpg'">
        <v-row>
          <v-col
            cols="5"
            md="5"
          ...
          <v-col
            ...
            sm="7"
            xl="7"
            style="padding: 5%; text-align: left"
          >
            <v-alert
      ...
      <div v-show="item.src === '/img/paisagem4.jpg'">
        <v-row>
          <v-col
            cols="5"
            md="5"
      ...
      <div v-show="item.src === '/img/paisagem7.jpg'">
        <v-row>
          <v-col
            cols="5"
            md="5"
